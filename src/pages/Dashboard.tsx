...
<<<<<<< Updated upstream
  ...
  } = usePassport(profile?.id);
=======
  const { data: profile, isLoading: profileLoading, isError: profileError } = useUser(clerkId);
  const { data: passport, isLoading: passportLoading, isError: passportError } = usePassport(profile?.id);
>>>>>>> Stashed changes

  const isLoading = profileLoading || passportLoading;
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          {isLoading ? (
            ...
            <h1 className="text-[32px] font-bold text-dark mb-2">
...
=======
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        {isError && (
          <div className="card-alert mb-6">
            <p className="text-destructive text-sm">Failed to load your data. Please refresh the page.</p>
          </div>
        )}
...
<<<<<<< Updated upstream
                    style={{
                      width: `${passport?.completion_percent ?? 0}%`,
                    }}
=======
...
<<<<<<< Updated upstream
            ...
            <Link to="/dashboard/upload" className="btn-secondary text-sm">
              + Upload Report
            </Link>
...
<<<<<<< Updated upstream
              ...
              {isLoading ? (
                ...
                <div className="flex flex-wrap gap-2 mb-3">
                  {passport.allergies.map((a: string) => (
                    <span key={a} className="badge-allergy">
                      {a}
                    </span>
                  ))}
                </div>
            ...
            <div className="card-base">
              ...
              {isLoading ? (
                ...
                <div className="flex flex-wrap gap-2 mb-3">
                  {passport.conditions.map((c: string) => (
                    <span key={c} className="badge-condition">
                      {c}
                    </span>
                  ))}
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  {passport.medicines.map((m: any) => (
                    <div key={m.id} className="card-base card-hover relative">
                      ...
                      <span className="badge-medicine mb-2 inline-block">
                        {m.name}
                      </span>
...
=======
              {isLoading ? (
                ...
                <div className="flex flex-wrap gap-2 mb-3">
                  {passport.allergies.map((a) => <span key={a} className="badge-allergy">{a}</span>)}
                </div>
              )}
            ...
            <div className="card-base">
              ...
              {isLoading ? (
                ...
                <div className="flex flex-wrap gap-2 mb-3">
                  {passport.conditions.map((c) => <span key={c} className="badge-condition">{c}</span>)}
                </div>
              )}
              ...
              {isLoading ? (
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  {passport.medicines.map((m) => (
                    <div key={m.id} className="card-base card-hover relative">
                      <button className="absolute top-3 right-3 text-muted-foreground hover:text-foreground" onClick={() => toast.info(COMING_SOON)}>
                        <Edit className="w-4 h-4" />
                      </button>
...
<<<<<<< Updated upstream
          ...
          <div className="lg:col-span-4">
            <div
              id="qr-card"
              className="card-base text-center sticky top-24"
            >
